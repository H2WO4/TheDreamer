...
import thedreamer.relics.FreeMind;
import thedreamer.util.IDCheck;
        ...
        PostInitializeSubscriber
{
    ...
    { // DON'T EDIT
        ...
        InputStream in = TheDreamer.class.getResourceAsStream("/IDCheckStrings.json"); // DON'T EDIT THIS ETHER
        ...
        logger.info("Success! ID is " + modID); // WHY WOULD U WANT IT NOT TO LOG?? DON'T EDIT 
    } // NO
    ...
    { // ALSO NO
        ...
        InputStream in = TheDreamer.class.getResourceAsStream("/IDCheckStrings.json"); // DON'T EDIT THISSSSS
    ...
    public void receiveEditRelics()
    {
        ...
        BaseMod.addRelicToCustomPool(new FreeMind(), Dreamer.Enums.COLOR_YELLOW);
