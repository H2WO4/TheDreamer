...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = TheDreamer.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main TheDreamer.java file in the
    ...
    // Go check out DefaultAttackWithVariable and TheDreamer.variable.DefaultCustomVariable
