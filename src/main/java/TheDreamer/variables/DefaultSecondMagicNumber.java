package TheDreamer.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import TheDreamer.cards.AbstractDefaultCard;

import static TheDreamer.TheDreamer.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "TheDreamer:" (or, your id) before the name.
    }
